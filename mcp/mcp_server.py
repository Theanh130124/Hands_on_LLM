...
if __name__ == "__main__":
    ...
    # print("Listening...")
    mcp.run(transport='sse') #'stdio'  #Lần đầu kết nói với Claude trên cần để về stdio và edit lại file claude_desktop_config của claude desktop